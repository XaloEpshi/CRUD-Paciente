...
var controllers = {
  ...
  // Controlador para deshabilitar un paciente (marcarlo como inactivo)
  delete: async (req, res) => {
    // Obtener el ID del paciente de los parámetros de la solicitud
    var id = req.params.id;

    try {
      // Actualizar el paciente estableciendo el campo 'activo' en false
      var pacienteInhabilitado = await Paciente.findByIdAndUpdate(
        id,
        { activo: false }, // Establecer el campo 'activo' en false
