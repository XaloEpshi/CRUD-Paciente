...
mongoose.connect('mongodb+srv://gonzalomellaom:gM8viBC7bwDsc9IO@pmnu1-c0.nsnw3zk.mongodb.net/hospital_alerce?retryWrites=true&w=majority&appName=PMNU1-C0').then(() => {
